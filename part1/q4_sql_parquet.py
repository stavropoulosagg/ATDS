...
if __name__ == "__main__":
    ...
    inputMovies = spark.read.format('parquet').load(sys.argv[1])
    inputMovies.registerTempTable("movies")
    #spark.sql("select _c3, _c5, _c6 from movies order by _c3 desc").show(30)
    inputGenres = spark.read.format('parquet').load(sys.argv[2])
    ...
    drama_movies.registerTempTable("drama_movies")
    #drama_movies.show()
    ...
    drama_movies_after_2K_lustrum_sum_len.registerTempTable("drama_movies_after_2K_lustrum_sum_len")
    ...
    total_summaries_per_5_years.registerTempTable("total_summaries_per_5_years")
    ...
    sum_summaries_per_5_years.registerTempTable("sum_summaries_per_5_years")
    ...
    average_summaries_per_5_years.show(50)
