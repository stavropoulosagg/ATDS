...
if __name__ == "__main__":
    ...
    inputRatings = spark.read.format('parquet').load(sys.argv[1])
    ...
    total_ratings_per_user.registerTempTable("total_ratings_per_user")
    ...
    sum_ratings_per_user.registerTempTable("sum_ratings_per_user")
    ...
    average_ratings_per_user.registerTempTable("average_ratings_per_user")
