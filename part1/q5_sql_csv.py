...
if __name__ == "__main__":
    ...
    ratings_with_genres_popularities.registerTempTable("ratings_with_genres_popularities") #[genre, user, title, rating, popularity]
    ...
    max_user_rating_per_genre_no_title.registerTempTable("max_user_rating_per_genre_no_title") #[genre, user, max_rating, max_popularity]
    ...
    max_user_rating_per_genre.registerTempTable("max_user_rating_per_genre") #[genre, user, title, max_rating, max_popularity]
    ...
    min_user_rating_per_genre_no_title.registerTempTable("min_user_rating_per_genre_no_title") #[genre, user, min_rating, max_popularity]
    ...
    min_user_rating_per_genre.registerTempTable("min_user_rating_per_genre") #[genre, user, title, min_rating, max_popularity]
    ...
    genres_users.registerTempTable("genres_users") #[genre, user, rating]
    ...
    user_ratings_per_genre.registerTempTable("user_ratings_per_genre") #[genre, user, total_ratings]
    ...
    max_user_per_genre.registerTempTable("max_user_per_genre") #[genre, user, max_ratings_of_genre]
