...
if __name__ == "__main__":
    ...
    inputGenres = spark.read.format('parquet').load(sys.argv[1])
    inputGenres.registerTempTable("genres")
    #spark.sql("select _c3, _c5, _c6 from movies order by _c3 desc").show(30)
    inputRatings = spark.read.format('parquet').load(sys.argv[2])
    ...
    total_ratings_per_movie.registerTempTable("total_ratings_per_movie")
    ...
    sum_ratings_per_movie.registerTempTable("sum_ratings_per_movie")
    ...
    average_ratings_per_movie.registerTempTable("average_ratings_per_movie")
    ...
    genres_ratings.registerTempTable("genres_ratings")
    
    total_ratings_per_genre = spark.sql("select genre, count(*) as ratings_genre from genres_ratings group by genre")
    total_ratings_per_genre.registerTempTable("total_ratings_per_genre")
    ...
    sum_ratings_per_genre.registerTempTable("sum_ratings_per_genre")
    ...
    average_ratings_per_genre.show(50)
